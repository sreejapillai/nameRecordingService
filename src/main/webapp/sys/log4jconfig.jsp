...
%>
	<div id="content">
		...
		<div class="filterForm">
			...
			<form action="log4jconfig.jsp" name="logFilterForm">
				Filter Loggers:&nbsp;&nbsp; <input name="logNameFilter" type="text"
					...
					type="button" value="Clear" class="filterButton"
    ...
    %>
			<tr>
                ...
                for (int cnt = 0; cnt < logLevels.length; cnt++) {
                    ...
                    String url = "log4jconfig.jsp?operation=changeLogLevel&logger=" + loggerName + "&newLogLevel=" + logLevels[cnt] + "&logNameFilter=" + (logNameFilter != null ? logNameFilter : "") + "&logNameFilterType=" + (logNameFilterType != null ? logNameFilterType : "");
